    ...
    public class alumPubSPController : ApiController
    {
        ...
        public HttpResponseMessage listManPropietarios()
        {
            ...
            try
            {
                ...
                query.CommandText = "select * from bkmilcp6nvs1hgkadyz6.alumPubSP";
        ...
        public HttpResponseMessage getMpId(string tipo)
        {
            try
            {
                ...
                query.CommandText = "selec * from bkmilcp6nvs1hgkadyz6.alumPubSP where tipo = " + tipo;
        ...
        public HttpResponseMessage crearMP(alumPubSP mp)
        {
            try
            {
                conn.Open();
                SqlCommand query = conn.CreateCommand();
                query.CommandText = "insert into bkmilcp6nvs1hgkadyz6.alumPubSP values (@tipo)";
        ...
        public HttpResponseMessage modificarMP(string old, alumPubSP mp)
        {
            try
            {
                conn.Open();
                SqlCommand query = conn.CreateCommand();
                query.CommandText = "update bkmilcp6nvs1hgkadyz6.alumPubSP set tipo = @tipo where tipo = " + old;
        ...
        public HttpResponseMessage deleteMP(string old)
        {
            try
            {
                conn.Open();
                SqlCommand query = conn.CreateCommand();
                query.CommandText = "delete from bkmilcp6nvs1hgkadyz6.alumPubSP where tipo = @tipo";
