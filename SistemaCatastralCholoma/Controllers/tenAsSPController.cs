    ...
    public class trenAsSPController : ApiController
    {
        ...
        public HttpResponseMessage listManPropietarios()
        {
            ...
            try
            {
                ...
                query.CommandText = "select * from bkmilcp6nvs1hgkadyz6.trenAsSP";
        ...
        public HttpResponseMessage getMpId(string tipo)
        {
            try
            {
                ...
                query.CommandText = "selec * from bkmilcp6nvs1hgkadyz6.trenAsSP where tipo = " + tipo;
        ...
        public HttpResponseMessage crearMP(trenAsSP mp)
        {
            try
            {
                conn.Open();
                SqlCommand query = conn.CreateCommand();
                query.CommandText = "insert into bkmilcp6nvs1hgkadyz6.trenAsSP values (@tipo)";
        ...
        public HttpResponseMessage modificarMP(string old, trenAsSP mp)
        {
            try
            {
                conn.Open();
                SqlCommand query = conn.CreateCommand();
                query.CommandText = "update bkmilcp6nvs1hgkadyz6.trenAsSP set tipo = @tipo where tipo = " + old;
        ...
        public HttpResponseMessage deleteMP(string old)
        {
            try
            {
                conn.Open();
                SqlCommand query = conn.CreateCommand();
                query.CommandText = "delete from bkmilcp6nvs1hgkadyz6.trenAsSP where tipo = @tipo";
